...
class Baccarat extends MultiplayerGame {
    ...
    public function onDispatchedFinish() {
        ...
        foreach($this->getActiveGames() as $game) {
            ...
            $this->win($game, $multiplier, ((count($result['player']) + count($result['dealer'])) * 900) + 500 + 300, $profit);
        }
    }
    ...
    private function deck() {
        return [
            ...
            11 => ['type' => 'spades', 'value' => 'J', 'baccaratValue' => 10],
            12 => ['type' => 'spades', 'value' => 'Q', 'baccaratValue' => 10],
            13 => ['type' => 'spades', 'value' => 'K', 'baccaratValue' => 10],
            ...
            24 => ['type' => 'hearts', 'value' => 'J', 'baccaratValue' => 10],
            25 => ['type' => 'hearts', 'value' => 'Q', 'baccaratValue' => 10],
            26 => ['type' => 'hearts', 'value' => 'K', 'baccaratValue' => 10],
            ...
            37 => ['type' => 'clubs', 'value' => 'J', 'baccaratValue' => 10],
            38 => ['type' => 'clubs', 'value' => 'Q', 'baccaratValue' => 10],
            39 => ['type' => 'clubs', 'value' => 'K', 'baccaratValue' => 10],
