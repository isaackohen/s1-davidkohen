                        ...
                        template: `
                            <div>
                                ...
                                <div class="overview-bet" v-if="response">
                                    <div class="option">{{ $t('general.bets.bet') }}: <span><icon :icon="currencies[response.info.currency].icon" :style="{ color: currencies[response.info.currency].style }"></icon> {{ response.info.wager.toFixed(8) }}</span><span><span>$</span>{{ (response.info.wager * this.currencies[response.info.currency].price).toFixed(2) }} </span></div>
                                    <div class="option">{{ $t('general.bets.mul') }}: <span>{{ response.info.status === 'lose' ? '0.00' : response.info.multiplier.toFixed(2) }}x</span></div>
                                    <div class="option">{{ $t('general.bets.win') }}: <span><icon :icon="currencies[response.info.currency].icon" :style="{ color: currencies[response.info.currency].style }"></icon> {{ response.info.profit.toFixed(8) }}</span><span><span>$</span>{{ (response.info.profit * this.currencies[response.info.currency].price).toFixed(2) }}</span></div>
                                </div>
