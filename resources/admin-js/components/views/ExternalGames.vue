<template>
        <div>
            ...
            <div class="col-md-12">
                ...
                <h4 class="mb-1 mt-0">External Settings</h4>
            </div>
        </div>
        <div class="row">
            <div class="col-xl-3 col-lg-6" v-for="setting in settingsData">
                <div class="card">
                    <div class="card-body">
    ...
    <div v-if="!modules">
        <div class="row page-title">
            <div class="col-md-12">
                <h4 class="mb-1 mt-1">External Games</h4>
            </div>
        </div>
        <div class="container-fluid">
            <div class="row">
                <div class="col-6 col-md-4" v-if="game.ext" v-for="game in games">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title mb-1">{{ game.name }}</h5>
                            <h6 class="text-muted font-weight-normal mt-0 mb-3">{{ game.id }}</h6>
                            <h6 class="text-muted font-weight-normal mt-0 mb-3">{{ game.p }}</h6>
                            <h6 class="text-muted font-weight-normal mt-0 mb-3">{{ game.desc }}</h6>
                ...
                <div class="col-12 col-md-4">
                    <div class="card">
                        <div class="card-body pt-2">
                            <h6 class="header-title mb-4">External Game Settings</h6>
...
<script>
    ...
    export default {
        created() {
          axios.post('/admin/externalgames/settings').then(({ data }) => this.settingsData = data);
        },
        data() {
            return {
                game: null,
