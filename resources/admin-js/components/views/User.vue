                        ...
                        <table id="datatable" class="table dt-responsive nowrap">
                            ...
                            <tbody>
                                <tr v-for="game in info.gamesArray">
									...
									<a href="javascript:void(0)" @click="viewDataGame(game._id, game.data)">View Data</a>
									</td>
                                    <td>
                        ...
                        <table id="transactions" class="table dt-responsive nowrap">
                            ...
                            <tbody>
                                <tr v-for="transaction in info.transactions">
                                    ...
                                    <td style="width: 80%">
                                        <div v-if="transaction.data.message != null">Message: {{ transaction.data.message ? transaction.data.message : '-' }}</div>
                                        <div v-if="transaction.data.game != null">Game: {{ transaction.data.game ? transaction.data.game : '-' }}</div>
                                        <div>
