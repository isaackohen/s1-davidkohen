                ...
                <div class="winners">
                    ...
                    <template v-else>
                        <div class="winner second" @click="leaderboard[1] ? $router.push(`/profile/` + leaderboard[1].user._id) : ''"
                             v-tooltip="leaderboard[1] ? leaderboard[1].user.name + `<br>` + '$ ' + leaderboard[1].entry.usd_profit.toFixed(2) : $t('general.become_top_player')">
                        ...
                        <div class="winner first" @click="leaderboard[0] ? $router.push(`/profile/` + leaderboard[0].user._id) : ''"
                             v-tooltip="leaderboard[0] ? leaderboard[0].user.name + `<br>` + '$ ' + leaderboard[0].entry.usd_profit.toFixed(2) : $t('general.become_top_player')">
                        ...
                        <div class="winner third" @click="leaderboard[2] ? $router.push(`/profile/` + leaderboard[2].user._id) : ''"
                             v-tooltip="leaderboard[2] ? leaderboard[2].user.name + `<br>` + '$ ' + leaderboard[2].entry.usd_profit.toFixed(2) : $t('general.become_top_player')">
                        ...
                        <div class="message-content">
                            ...
                            <div class="content">
                                ...
                                <div class="answer">
                                    ...
                                    <div><span style="margin-right:2px;" v-if="usd">$</span><unit :to="message.data.currency" :value="message.data.reward"></unit> {{ currencies[message.data.currency].name }}</div>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="content">
                                ...
                                <div class="game-link" @click="openOverviewModal(message.data._id, message.data.game)">
                                    ...
                                    <div class="content">
                                        ...
                                        <div>{{ $t('general.bets.bet')}}: <span style="margin-right:2px;" v-if="usd">$</span><unit :to="message.data.currency" :value="message.data.wager"></unit> <icon :icon="currencies[message.data.currency].icon" :style="{ color: currencies[message.data.currency].style }"></icon></div>
                    ...
                    <div v-else-if="message.type === 'tip'" :key="j" class="message tip">
                        ...
                        <div class="message-content">
                            ...
                            <div class="content" v-html="$t('general.tip_chat', {
                                ...
                                value: usd ? ('$' + (currencies[message.data.currency].price * parseFloat(message.data.amount)).toFixed(2)) : rawBitcoin(message.data.currency, parseFloat(message.data.amount)),
                        ...
                        <div class="message-content">
                            <div class="content">
                                ...
                                <div class="mt-2 rain_desc" v-html="$t(`general.${isSummer() ? 'rain' : 'snow'}`, {
                                    sum: usd ? ('$' + (currencies[message.data.currency].price * parseFloat(message.data.reward)).toFixed(2)) : rawBitcoin(message.data.currency, message.data.reward),
                                    currency: currencies[message.data.currency].name
                                })"></div>
...
<script>
    ...
    export default {
        computed: {
            ...mapGetters(['user', 'isGuest', 'chat', 'channel', 'currencies', 'currency', 'unit', 'locale', 'usd'])
        },
        created() {
