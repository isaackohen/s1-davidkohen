    ...
    <div class="container-fluid">
        <div class="walletPage">
            ...
            <div class="walletTabs">
                ...
                <div :class="`walletTab ${tab === 'exchange' ? 'active' : ''}`" @click="loadTab('exchange')" v-if="exchangeAvailable">{{ currency.startsWith('local_bonus') ? $t('wallet.tabs.exchange_bonus') : $t('wallet.tabs.exchange') }}</div>
            </div>
								...
								<template v-if="!user.user.first_deposit_bonus || user.user.first_deposit_bonus !== 'used'"> 
									...
									<div class="walletOut deposit-bonus">
										...
										<template v-if="!user.user.first_deposit_bonus">
											...
											<div style="margin-top: 10px;">{{ $t('bonus.doubler_deposit.rules') }}</div>   
										</template>
