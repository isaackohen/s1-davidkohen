                        ...
                        template: `
                            <div>
                                ...
                                <div class="bonus-image">
                                    ...
                                    <div :class="'btn btn-primary mt-2' + (user.user.weekly_bonus < 0.1 ? 'disabled' : '')" v-html="$t('general.take', { value: usd ? ('$' + ((((user.user.weekly_bonus ?? 0) / 100) * user.user.vipBonus) * currencies[currencies.vipClosestId].price).toFixed(3)) : (((user.user.weekly_bonus ?? 0) / 100) * user.user.vipBonus).toFixed(currency.startsWith('local_') ? 2 : 8) })" @click="user.user.weekly_bonus < (currency.startsWith('local_') ? 0.1 : 0.00000001) ? '' : collect()"></div>
                                </div>
