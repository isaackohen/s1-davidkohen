<script>
    ...
    class Modal {
        ...
        partner() {
            const v = this.vm.currencies[this.vm.$data.currency_abs].price, rewards = [
                {
                    value: this.vm.usd ? this.vm.$data.partner_slice[0] : this.vm.rawBitcoin(this.vm.$data.currency_abs, this.vm.usdToToken(v, this.vm.$data.partner_slice[0])),
                    color: '#f46e42'
                },
                {
                    value: this.vm.usd ? this.vm.$data.partner_slice[1] : this.vm.rawBitcoin(this.vm.$data.currency_abs, this.vm.usdToToken(v, this.vm.$data.partner_slice[1])),
                    color: '#508bf0'
                },
                {
                    value: this.vm.usd ? this.vm.$data.partner_slice[2] : this.vm.rawBitcoin(this.vm.$data.currency_abs, this.vm.usdToToken(v, this.vm.$data.partner_slice[2])),
                    color: '#df1347'
                },
                {
                    value: this.vm.usd ? this.vm.$data.partner_slice[3] : this.vm.rawBitcoin(this.vm.$data.currency_abs, this.vm.usdToToken(v, this.vm.$data.partner_slice[3])),
                    color: '#d1d652'
                },
                {
                    value: this.vm.usd ? this.vm.$data.partner_slice[4] : this.vm.rawBitcoin(this.vm.$data.currency_abs, this.vm.usdToToken(v, this.vm.$data.partner_slice[4])),
                    color: '#ffc645'
                },
                {
                    value: this.vm.usd ? this.vm.$data.partner_slice[5] : this.vm.rawBitcoin(this.vm.$data.currency_abs, this.vm.usdToToken(v, this.vm.$data.partner_slice[5])),
                    color: '#f46e42'
                },
                {
                    value: this.vm.usd ? this.vm.$data.partner_slice[6] : this.vm.rawBitcoin(this.vm.$data.currency_abs, this.vm.usdToToken(v, this.vm.$data.partner_slice[6])),
                    color: '#508bf0'
                },
                {
                    value: this.vm.usd ? this.vm.$data.partner_slice[7] : this.vm.rawBitcoin(this.vm.$data.currency_abs, this.vm.usdToToken(v, this.vm.$data.partner_slice[7])),
                    color: '#df1347'
                },
                {
                    value: this.vm.usd ? this.vm.$data.partner_slice[8] : this.vm.rawBitcoin(this.vm.$data.currency_abs, this.vm.usdToToken(v, this.vm.$data.partner_slice[8])),
                    color: '#d1d652'
                },
                {
                    value: this.vm.usd ? this.vm.$data.partner_slice[9] : this.vm.rawBitcoin(this.vm.$data.currency_abs, this.vm.usdToToken(v, this.vm.$data.partner_slice[9])),
                    color: '#ffc645'
                },
                {
                    value: this.vm.usd ? this.vm.$data.partner_slice[10] : this.vm.rawBitcoin(this.vm.$data.currency_abs, this.vm.usdToToken(v, this.vm.$data.partner_slice[10])),
                    color: '#f46e42'
                },
                {
                    value: this.vm.usd ? this.vm.$data.partner_slice[11] : this.vm.rawBitcoin(this.vm.$data.currency_abs, this.vm.usdToToken(v, this.vm.$data.partner_slice[11])),
                    color: '#508bf0'
                },
                {
                    value: this.vm.usd ? this.vm.$data.partner_slice[12] : this.vm.rawBitcoin(this.vm.$data.currency_abs, this.vm.usdToToken(v, this.vm.$data.partner_slice[12])),
                    color: '#df1347'
                },
                {
                    value: this.vm.usd ? this.vm.$data.partner_slice[13] : this.vm.rawBitcoin(this.vm.$data.currency_abs, this.vm.usdToToken(v, this.vm.$data.partner_slice[13])),
                    color: '#d1d652'
                }
            ];
            let slides = [];
